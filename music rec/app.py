...
if search_keyword is not None and len(str(search_keyword)) > 0:
    if search_selected == 'Song/Track':
        ...
        tracks = sp.search(q='track:'+ search_keyword,type='track', limit=50)
        ...
        artists = sp.search(q='artist:'+ search_keyword,type='artist', limit=50)
    ...
    if search_selected == 'Album':
        ...
        albums = sp.search(q='album:'+ search_keyword,type='album', limit=50)
